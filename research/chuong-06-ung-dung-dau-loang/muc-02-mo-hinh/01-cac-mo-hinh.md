# Chương 6: Các Model Deep Learning cho Oil Spill Detection

## 6.9. Tổng quan về Approaches

**Tham chiếu kiến trúc:** Các kiến trúc segmentation cơ bản (U-Net, DeepLabV3+, PSPNet, HRNet) đã được trình bày chi tiết tại **Chương 3.3 - Semantic Segmentation**. Phần này tập trung vào việc áp dụng và điều chỉnh các kiến trúc đó cho bài toán oil spill detection với dữ liệu SAR.
...
## 6.10. Encoder-Decoder Architectures

### 6.10.1. U-Net cho Oil Spill Detection

**Tham khảo:** Kiến trúc U-Net đã được mô tả chi tiết tại **Mục 3.3.2**. Phần này mô tả các điều chỉnh đặc thù cho SAR oil spill detection.
...
### 6.10.3. DeepLabV3+ cho Oil Spill Detection

**Tham khảo:** Kiến trúc DeepLabV3+ và ASPP module đã được trình bày tại **Mục 3.3.3**.
...
### 6.10.4. PSPNet (Pyramid Scene Parsing Network)
...
## 6.11. Feature Pyramid Networks

### 6.11.1. FPN-based Segmentation
...
### 6.11.2. PANet (Path Aggregation Network)
...
## 6.12. Attention-based Models

### 6.12.1. Attention U-Net
...
### 6.12.2. Self-Attention và Transformers
...
### 6.12.3. Dual-Attention Networks
...
## 6.13. Multi-scale và Multi-resolution Approaches

### 6.13.1. HRNet (High-Resolution Network)
...
## 6.14. Multi-task và Auxiliary Learning

### 6.14.1. Oil Spill + Look-alike Classification
...
### 6.14.2. Segmentation + Confidence Estimation
...
### 6.14.3. Joint Ship và Oil Spill Detection
...
## 6.15. Approaches cho Look-alike Discrimination

### 6.15.1. Contextual Feature Extraction
...
## 6.16. Loss Functions cho Oil Spill Detection

### 6.16.1. Binary Cross-Entropy (BCE)
...
### 6.16.5. IoU Loss (Jaccard Loss)

Similar concept to Dice, directly optimize IoU:
IoU Loss = 1 - |P∩G| / |P∪G|

### 6.16.6. Combined Loss Functions
...
## 6.17. Polarimetric SAR Features

### 6.17.1. Dual-Pol và Quad-Pol Data
...
### 6.17.2. Polarimetric Features cho Deep Learning
...
## 6.18. So sánh và Lựa chọn Model

### 6.18.1. Bảng So sánh Performance
...
### 6.18.2. Recommendations theo Use Case
...
### 6.18.3. Implementation Considerations
