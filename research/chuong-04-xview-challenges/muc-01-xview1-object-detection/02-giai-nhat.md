# 4.1.2 Giải Pháp Hạng Nhất xView1: Reduced Focal Loss
...
> **Tham khảo Chương 3**: Kiến trúc ResNet được trình bày chi tiết tại [Mục 3.2 - Classification Models](/chuong-03-kien-truc-model/muc-02-classification/01-classification-models), và FPN được giới thiệu trong [Mục 2.2.2 - Phát hiện đối tượng](/chuong-02-co-so-ly-thuyet/muc-02-phuong-phap-xu-ly-anh/02-phat-hien-doi-tuong).
