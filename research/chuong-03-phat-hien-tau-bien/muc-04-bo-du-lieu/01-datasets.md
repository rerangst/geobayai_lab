# Chương 3: Datasets cho Ship Detection

## 4.20. Tổng quan về Ship Detection Datasets
...
## 4.21. SAR Ship Detection Datasets

### 4.21.1. SSDD (SAR Ship Detection Dataset)
...
### 4.21.2. HRSID (High-Resolution SAR Images Dataset)
...
xView3-SAR là dataset từ xView3 challenge, focus vào maritime detection cho anti-IUU fishing.
...
## 4.22. Optical Ship Detection Datasets

### 4.22.1. HRSC2016 (High Resolution Ship Collection 2016)
...
### 4.22.2. HRSC2016-MS (Multi-Scale Extension)
...
### 4.22.4. FGSD (Fine-Grained Ship Detection)
...
## 4.23. So sánh Datasets

### 4.23.1. Bảng So sánh Tổng hợp
...
### 4.23.2. Recommendations theo Use Case
...
## 4.24. Cách Sử dụng Datasets

### 4.24.1. Download và Setup
...
## 4.25. Tạo Custom Dataset

### 4.25.1. Khi nào cần Custom Dataset
...
### 4.25.4. Data Augmentation cho Small Datasets

Khi custom dataset nhỏ:
- Extensive augmentation
- Transfer learning từ larger datasets
