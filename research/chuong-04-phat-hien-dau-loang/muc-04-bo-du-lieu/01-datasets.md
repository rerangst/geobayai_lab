# Chương 4: Datasets cho Oil Spill Detection

## 5.30. Tổng quan về Oil Spill Datasets
...
## 5.31. Datasets Chính cho SAR Oil Spill Detection

### 5.31.1. Oil Spill Detection Dataset (Kaggle/Zenodo)
...
### 5.31.2. SOS Dataset (Sea Oil Spill)
...
### 5.31.3. NOAA Oil Spill Datasets
...
### 5.31.5. Research Group Datasets
...
## 5.32. Multi-class và Look-alike Datasets

### 5.32.1. Oil Spill Look-alike Dataset
...
### 5.32.2. Extended Annotation Datasets
...
## 5.33. Competition Datasets

### 5.33.1. DARPA Challenges
...
## 5.34. Synthetic và Augmented Datasets

### 5.34.1. Simulated Oil Spill Data
...
### 5.34.2. Augmentation Strategies
...
### 5.34.3. Transfer Learning Datasets
...
## 5.35. Optical Oil Spill Datasets

### 5.35.1. Satellite Optical Data
...
### 5.35.3. Multi-sensor Fusion Datasets
...
## 5.36. Dataset Creation Guidelines

### 5.36.1. Data Collection
...
## 5.37. Dataset Challenges và Limitations

### 5.37.1. Limited Positive Samples
...
### 5.37.3. Geographic và Temporal Bias
...
## 5.38. So sánh Datasets

### 5.38.1. Bảng So sánh Tổng hợp
...
### 5.38.2. Recommendations theo Use Case
...
## 5.39. Accessing và Using Datasets

### 5.39.1. Public Dataset Access
...
## 5.40. Future Directions

### 5.40.1. Larger Benchmark Datasets
...
### 5.40.3. Multi-modal Integration
