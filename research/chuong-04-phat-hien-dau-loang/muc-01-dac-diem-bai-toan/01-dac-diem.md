# Chương 4: Đặc điểm Bài toán Oil Spill Detection

## 5.1. Tổng quan về Oil Spill Detection
...
## 5.2. Tại sao SAR là Sensor Chính cho Oil Spill Detection

### 5.2.1. Nguyên lý Phát hiện Dầu bằng SAR
...
### 5.2.2. Ưu điểm của SAR so với Optical Sensors
...
### 5.2.3. Hạn chế và Thách thức của SAR
...
## 5.3. Optical Imagery cho Oil Spill Detection

### 5.3.1. Khả năng Phát hiện
...
### 5.3.2. Hạn chế của Optical Sensors
...
## 5.4. Định dạng Bài toán Machine Learning
...
## 5.5. Thách thức Đặc thù của Oil Spill Detection
...
### 5.5.2. Look-alike Discrimination
...
### 5.5.3. Variability của Oil Spill Appearance
...
### 5.5.5. Generalization across Regions
...
## 5.6. Metrics Đánh giá

### 5.6.1. Pixel-level Metrics
...
## 5.7. So sánh với Ship Detection

### 5.7.1. Điểm Tương đồng
...
## 5.8. Các Hệ thống Giám sát Thực tế

### 5.8.1. CleanSeaNet (European Maritime Safety Agency)
