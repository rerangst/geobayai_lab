# Chương 5: Quy trình Ship Detection Pipeline

## 5.11. Tổng quan Pipeline
...
flowchart TD
    ...
    B --> B1[SAR: Calibration, Speckle Filtering]
    B --> B2[Optical: Atmospheric Correction]
    D --> D1[YOLOv8 / Faster R-CNN]
    D --> D2[TTA if needed]
    E --> E1[NMS / Soft-NMS]
    E --> E2[Filtering]
```

## 5.12. Data Acquisition

### 5.12.1. SAR Data Sources
...
### 5.12.3. Data Download và Management
...
### 5.13.1. SAR Preprocessing Pipeline
...
### 5.13.2. Optical Preprocessing Pipeline
...
## 5.14. Data Augmentation

### 5.14.1. Geometric Augmentations
...
### 5.14.2. Photometric Augmentations (Optical)
...
### 5.14.3. SAR-specific Augmentations
...
### 5.15.1. Transfer Learning Strategy
...
### 5.16.2. Test Time Augmentation (TTA)
...
## 5.17. Post-processing

### 5.17.1. Non-Maximum Suppression (NMS)
...
## 5.18. Integration và Output

### 5.18.1. AIS Correlation
...
### 5.18.4. Visualization và Reporting

---

**Tóm tắt:** Pipeline hoàn chỉnh từ thu thập dữ liệu vệ tinh đến output cuối cùng, bao gồm preprocessing SAR/optical, model inference với pretrained weights từ TorchGeo, và integration với hệ thống AIS. Phần tiếp theo sẽ trình bày các datasets quan trọng cho training và benchmarking.
