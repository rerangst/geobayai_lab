# Chương 5: Ứng dụng - Phát hiện Tàu biển

## Giới thiệu Chương

Chương này áp dụng các kiến trúc object detection từ **Chương 3** và các kỹ thuật từ cuộc thi xView3-SAR (**Chương 4.3**) vào bài toán thực tế: phát hiện tàu biển trên ảnh viễn thám. Đây là ứng dụng quan trọng trong giám sát hàng hải và chống đánh bắt bất hợp pháp (IUU fishing).

## 5.1. Giới thiệu về Ship Detection
...
## 5.2. Tầm quan trọng và Ứng dụng

### 5.2.1. Giám sát An ninh Hàng hải
...
### 5.2.2. Chống Đánh bắt Bất hợp pháp (IUU Fishing)
...
### 5.2.4. Ứng phó Tìm kiếm Cứu nạn (SAR Operations)
...
### 5.2.5. Phát hiện Tràn dầu từ Tàu
...
## 5.3. Các Thách thức trong Ship Detection

### 5.3.1. Kích thước Đối tượng Đa dạng
...
### 5.3.2. Môi trường Biển Phức tạp
...
### 5.3.3. Tàu gần Bờ và trong Cảng
...
### 5.3.4. Oriented Objects và Aspect Ratio
...
### 5.3.5. Dense and Occluded Ships
...
### 5.3.6. Đặc thù của Ảnh SAR

Synthetic Aperture Radar (SAR - xem **Chương 2.1.4**) là nguồn dữ liệu chính cho ship detection do khả năng hoạt động 24/7 bất kể thời tiết. Tuy nhiên, ảnh SAR có những đặc thù riêng:
...
## 5.4. SAR vs Optical Imagery cho Ship Detection

### 5.4.1. Ưu điểm của SAR
...
### 5.4.3. Ưu điểm của Optical Imagery
...
### 5.4.4. Hạn chế của Optical Imagery
...
**Tóm tắt:** Chương này đã giới thiệu bài toán ship detection trong bối cảnh Việt Nam, phân tích các ứng dụng thực tiễn, và xác định các thách thức kỹ thuật chính. Phần tiếp theo sẽ trình bày các mô hình deep learning được áp dụng để giải quyết bài toán này.
